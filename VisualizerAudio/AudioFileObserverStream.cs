...
namespace VisualizerAudio
{
    ...
    /// Repurposed from audio file reader code at: https://github.com/naudio/NAudio/blob/master/NAudio/Wave/WaveStreams/AudioFileReader.cs
    /// </summary>
    public class AudioFileObserverStream : WaveStream, ISampleProvider
    {
        ...
        public event EventHandler<byte[]> OnBytesRead;

        /// <summary>
        /// Initializes a new instance of AudioFileReader
        /// </summary>
        /// <param name="fileName">The file to open</param>
        public AudioFileObserverStream(string fileName)
        {
        ...
        public override int Read(byte[] buffer, int offset, int count)
        {
            ...
            OnBytesRead?.Invoke(this, buffer);
